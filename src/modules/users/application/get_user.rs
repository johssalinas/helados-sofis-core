...
pub async fn by_id(repo: &Arc<dyn UserRepository>, id: Uuid) -> Result<User, AppError> {
    repo.find_by_id(id)
        .await?
...
pub async fn by_email(repo: &Arc<dyn UserRepository>, email: &str) -> Result<User, AppError> {
